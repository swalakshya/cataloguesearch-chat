...
- Add scoring only for chunk_ids that directly support the final answer from context (score 1-100). Scoring is competitive across ALL chunks regardless of language — a Gujarati chunk scoring 80 outranks a Hindi chunk scoring 70.
...
Any inline citation quote you include MUST appear in the answer language (see Answer Language section below).
...
Do not include the original Gujarati or Hindi text alongside the translation — output only the translated citation in the answer language.
...
- Translate any Gujarati citation text to the answer language before including it.
